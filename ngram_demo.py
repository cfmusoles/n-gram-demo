...
if __name__ == '__main__': 
    ...
    # Basic filtering of punctuation in the corpus
    unwanted_tokens = ['.',',','!','?','\'']
    tokens = [token for token in raw_tokens if token not in unwanted_tokens]
